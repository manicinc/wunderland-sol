...
/**
 * Podcast Generator — ElevenLabs TTS
 * Generates a full podcast episode from scripted dialogue using two voices.
 * Concatenates segments and applies 1.45x speed.
...
const VOICES = {
  JOSH: {
    id: 'TxGEqnHWrfWFTfGW9XjX',   // Josh — Young, dynamic male
    name: 'Josh',
    settings: { stability: 0.30, similarity_boost: 0.80, style: 0.60, use_speaker_boost: true },
  },
  ADAM: {
    id: 'EXAVITQu4vr4xnSDxMaL',   // Bella — Soft, warm female
    name: 'Bella',
