 ...
 * @module __tests__/unit/components/quarry/quick-actions/QuickCreateFAB.test
 *
...
// Mock hooks
vi.mock('@/components/quarry/hooks/useHaptics', () => ({
  useHaptics: () => ({
    haptic: vi.fn(),
  }),
}))

vi.mock('@/components/quarry/hooks/useIsTouchDevice', () => ({
