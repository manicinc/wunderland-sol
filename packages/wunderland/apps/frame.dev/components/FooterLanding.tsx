/**
 * FooterLanding - Lightweight CSS-only footer for landing pages
 * 
 * PERFORMANCE OPTIMIZED:
 * - Server Component (no 'use client')
 * - No framer-motion - uses CSS animations
...
export function FooterLanding() {
  return (
    <footer
      className="mt-20 animate-fade-in [animation-delay:500ms] [animation-fill-mode:backwards]"
      role="contentinfo"
    >
      {/* Discord CTA Banner */}
      ...
      <nav className="container mx-auto px-4" aria-label="Footer navigation">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 max-w-5xl mx-auto mb-12">
          ...
          <div>
            <p className="font-bold text-sm mb-3 text-gray-600 dark:text-gray-400 uppercase tracking-wider">Quarry</p>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/quarry/landing" className="nav-link text-gray-700 dark:text-gray-300 hover:text-frame-green">Product Overview</Link></li>
          ...
          <div>
            <p className="font-bold text-sm mb-3 text-gray-600 dark:text-gray-400 uppercase tracking-wider">Products</p>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <p className="font-bold text-sm mb-3 text-gray-600 dark:text-gray-400 uppercase tracking-wider">Company</p>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <p className="font-bold text-sm mb-3 text-gray-600 dark:text-gray-400 uppercase tracking-wider">Connect</p>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <p className="font-bold text-sm mb-3 text-gray-600 dark:text-gray-400 uppercase tracking-wider">Legal</p>
            <ul className="space-y-2 text-sm">
        ...
        <div className="text-center py-6 border-t border-gray-200/50 dark:border-gray-700/50">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">
            © 2025 Frame.dev • Infrastructure for agentic AI
          </p>
