...
import { TutorialStep } from './ui/misc/TutorialTour'
...
export const TUTORIALS: Record<TutorialId, TutorialConfig> = {
  ...
  navigation: {
    ...
    steps: [
      {
        id: 'nav-tabs',
        target: '[data-testid="strand-tab-bar"]',
        title: 'VS Code-style Tabs',
        description: 'Open multiple strands in tabs, just like your IDE. Drag tabs to reorder them.',
        placement: 'bottom',
      },
      {
        id: 'nav-single-click',
        target: '[data-testid="codex-sidebar"]',
        title: 'Single-Click Preview',
        description: 'Single-click a strand to preview it. The tab shows italicized text for preview mode.',
        placement: 'right',
      },
      {
        id: 'nav-double-click',
        ...
        description: 'Double-click to open a strand as a permanent tab that won\'t be replaced.',
        placement: 'right',
      },
      {
        id: 'nav-drag-to-tabs',
        target: '[data-testid="strand-tab-bar"]',
        title: 'Drag to Tab Bar',
        description: 'Drag any strand from the sidebar and drop it on the tab bar to open as a new tab.',
        placement: 'bottom',
      },
      {
        id: 'nav-breadcrumbs',
