...
import { HelpCircle, Book, Search, GitPullRequest, CheckCircle, RotateCcw, Brain, PenTool, BookOpen } from 'lucide-react'
import { TUTORIALS, type TutorialId } from '../../tutorials'
import { isTutorialCompleted, resetAllTutorials } from '../misc/TutorialTour'
          ...
          >
            ...
            <div className="p-2">
              {Object.values(TUTORIALS).map((tutorial) => {
                const Icon = icons[tutorial.id] || HelpCircle
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* Accessing the first step description if description on tutorial is not available, assuming steps exist */}
                      <p className="text-xs text-gray-600 dark:text-gray-400">
                        {tutorial.steps[0]?.description || 'Start this tutorial'}
                      </p>
