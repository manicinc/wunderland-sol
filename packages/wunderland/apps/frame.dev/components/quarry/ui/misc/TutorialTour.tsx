...
export default function TutorialTour({
  ...
  // Guard against undefined or empty steps array
  ...
  return (
    <>
      ...
      <div 
        ...
        style={{ zIndex: Z_INDEX.TUTORIAL_BACKDROP }}
        onClick={onSkip} 
      />
      ...
      <AnimatePresence>
        <motion.div
          ...
          className="fixed w-80 max-w-[90vw]"
          style={{ ...tooltipStyle, zIndex: Z_INDEX.TUTORIAL_CONTENT }}
        >
