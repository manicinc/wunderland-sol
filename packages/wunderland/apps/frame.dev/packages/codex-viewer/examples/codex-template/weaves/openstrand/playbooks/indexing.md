...
suggestedQuestions:
  - question: "How does full-text search work in the Codex viewer?"
    difficulty: intermediate
    tags: [search, indexing]
  - question: "What is the difference between tree filter and semantic search?"
    difficulty: beginner
    tags: [search, comparison]
  - question: "How do I regenerate the codex-index.json file?"
    difficulty: beginner
    tags: [indexing, workflow]
publishing:
  status: published
---
...
git add apps/quarry/codex-index.json
