        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1fr,340px]">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-700">
              This template mirrors the Quarry Codex stack—semantic search, bookmarks, analog theming, and privacy-first history controls. It ships with the actual OpenStrand schema docs (`weaves/openstrand/**`) so you can see how weaves, looms, and strands map to the analog OS.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link
                href="/quarry/openstrand/overview"
