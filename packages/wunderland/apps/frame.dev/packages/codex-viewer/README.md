...
- **Community Edition** – This package + [`framersai/codex`](https://github.com/framersai/codex) repo let you self-host everything for free under the MIT license. Ideal for open knowledge bases, personal fabrics, and experimentation.
- **Lifetime Edition** – A one-time purchase for organizations that need sovereign storage (S3, Postgres, Snowflake, on-prem), scheduled exports, encrypted offline bundles, and premium governance tooling. Join the waitlist at [frame.dev/quarry/waitlist](https://frame.dev/quarry/waitlist).
...
The viewer expects a GitHub repo that follows the Quarry Codex hierarchy — a **Fabric** (the whole repo) composed of
