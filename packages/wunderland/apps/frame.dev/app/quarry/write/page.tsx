/**
 * Write Mode Page - Prompt Explorer
 * @module app/quarry/write/page
 *
 * Visual prompt exploration experience with bento grid gallery.
 * Features mood-based prompt sections, category filtering, and search.
 * Discovery-first writing with 222 prompts and 120 cover images.
 */
...
// Dynamically import the PromptExplorerMode component to avoid SSR issues with localStorage
