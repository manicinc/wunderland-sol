...
// Tool imports removed — tutor, coding assistant, and diary tools are
// parent-monorepo-specific and not used in the standalone Wunderland backend.
...
export class LlmConfigService {
  ...
  private loadAgentToolDefinitions(): void {
    ...
    // Standalone Wunderland backend does not use parent-monorepo tools
    // (tutor, coding assistant, diary). Agent tool definitions are empty.
    console.log('[LlmConfigService] No agent-specific tools loaded (standalone mode).');
  }
