 ...
 * @description REST endpoints for multi-tenant OAuth channel connections.
 *
 * Routes:
 *   GET    /wunderland/channels/oauth/slack/initiate       - Start Slack OAuth
 *   GET    /wunderland/channels/oauth/discord/initiate     - Start Discord OAuth
 *   POST   /wunderland/channels/oauth/slack/callback       - Handle Slack callback (internal)
 *   POST   /wunderland/channels/oauth/discord/callback     - Handle Discord callback (internal)
 *   POST   /wunderland/channels/oauth/telegram/setup       - Telegram guided setup
 *   GET    /wunderland/channels/oauth/:platform/status     - Connection status
 *   DELETE /wunderland/channels/oauth/:platform/disconnect - Disconnect channel
 */
...
export class ChannelOAuthController {
  ...
  // ── OAuth Callbacks (called from Next.js API routes, not user-facing) ──
